...
function getData() {
    ...
    fetch('https://api.teleport.org/api/urban_areas/slug:tokyo/scores/')
        ...
        .then(data => {
                ...
                console.log("The Scores out of 10 for Tokyo are as follows: ");
                ...
                ranking.innerHTML = "Tokyo currently has an overall score of " + "<b>" + Math.floor(rankingValue) + "</b>";
